...
I program in python, c++, javascript, html, css, MATLAB, etc.
I will include useful MATLAB code which I write for my Mechanical Engineering M.S. along the way.
I am also working on desktop tools for the software integration of my hardware systems using python and PyQt.
